...
for datafile in datafiles:
    for i in range(1):
        # Xapp, Xapplabels, Xtest, Xtestlabels = tp.set_sdata(datafile, 340)
        Xapp, Xapplabels, Xtest, Xtestlabels = tp.set_sdata(datafile, 300)
        ...
        #
        # with open('perf' + '_' + str(i) + '.txt', 'a') as f:
        #     f.write(datafile + '\n')
        ...
        # fig.tight_layout()
        # fig.savefig(datafile + '_' + str(i) + '_app_carte.png')
        #
        ...
        # fig = ctk.showrefpat(sMap, Xapp, 16, 16, MBMUS, HITS, sztext=5, axis='tight', ticks='off')
        # fig.tight_layout()
        ...
        #                     sztext = 16, cmap = cm.jet, showcellid = False)
        # fig.tight_layout()
        # fig.savefig(datafile + '_' + str(i) + '_test_carte.png')
        #
        # CBLABELS = ctk.cblabfreq(Tfreq, Ulab)
        # fig = ctk.showcarte(sMap, figlarg=12, fighaut=12, shape='s', shapescale=600, colcell=CBilabmaj, text=CBLABELS,
        #                     sztext=16, cmap=cm.jet, showcellid=False)
        ...
        # fig = ctk.showrefpat(sMap, Xtest, 4, 8, MBMUS, HITS, sztext=5, axis='tight', ticks='off')
        fig = ctk.showrefpat(sMap, Xtest, 16, 16, MBMUS, HITS, sztext=5, axis='tight', ticks='off')
        fig.tight_layout()
